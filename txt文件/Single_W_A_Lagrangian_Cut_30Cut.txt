...
# 引用正反向动力学解算程序
sys.path.insert(0, r"D:\PYTHON\layout design\Simulated_Sampling")
from Calculate_Glider_Control_Commands import (
    calculate_glider_control_commands,
    calculate_true_glider_motion,
)
