"""
Shiyan2.py 绘图模块
可视化实验组2采样：前半段受拉格朗日影响（只受垂直水流），后半段恢复不受影响
"""
...
from Shiyan2 import run_single_shiyan2
...
def plot_shiyan2(t_array, w_isw_array, depth_obs, mode_array, t_meet, thermocline_depth, error_pct):
    """
    可视化实验组2采样：
    ...
    ax1.set_title(f'Shiyan2: Hybrid Lagrangian Sampling (Error: {error_pct:.2f}%)', fontsize=14)
...
if __name__ == "__main__":
    ...
    try:
        result = run_single_shiyan2(path, return_full=True)
