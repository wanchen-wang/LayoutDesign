...
def batch_process_multiple_thresholds(
    ...
    for pct_int in threshold_list:
        ...
        # 检测文件是否已存在，若存在则跳过该阈值
        output_filename = DEFAULT_RESULTS_DIR / f"analysis_results_swA_lagrangian_hor_cut{pct_int}.csv"
        ...
        for folder_name in wave_folders:
            ...
            try:
                ...
                interp_u = RegularGridInterpolator((x_grid, z), U_Vel_xz, bounds_error=False, fill_value=0.0)
