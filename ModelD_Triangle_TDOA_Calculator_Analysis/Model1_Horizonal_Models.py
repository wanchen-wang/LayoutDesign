...
WAVE_DATA_LINE_DIR = PROJECT_ROOT / "ModelA_Virtual_Internal_Solitary_Wave_Data_Generation" / "V_Wave_Data_Line"
SWA_DIR = MODULE_DIR
ANALYSIS_OUTPUT_DIR = MODULE_DIR / "Analysis_C_Data"
...
if __name__ == "__main__":
    base_data_dir = str(WAVE_DATA_LINE_DIR)
