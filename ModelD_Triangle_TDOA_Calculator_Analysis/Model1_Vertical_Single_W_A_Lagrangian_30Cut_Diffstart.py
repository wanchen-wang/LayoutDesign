...
DEFAULT_V_WAVE_DATA_LINE_DIR = PROJECT_ROOT / "ModelA_Virtual_Internal_Solitary_Wave_Data_Generation" / "V_Wave_Data_Line"
DEFAULT_SINGLE_GLIDER_OUTPUT_DIR = MODULE_DIR / "Analysis_C_Data" / "Trajectories"
DEFAULT_SINGLE_GLIDER_OUTPUT_CSV = DEFAULT_SINGLE_GLIDER_OUTPUT_DIR / "analysis_results_swA_lagrangian_30Cut_Diffstart.csv"
...
# ==========================================
def run_batch_30cut(
    base_data_dir=DEFAULT_V_WAVE_DATA_LINE_DIR,
...
if __name__ == "__main__":
    print("固定 30% 截断批处理")
    print("可选输入处理组范围和处理组数，默认输出到 ModelD_Triangle_TDOA_Calculator_Analysis/Analysis_C_Data/Trajectories。")
